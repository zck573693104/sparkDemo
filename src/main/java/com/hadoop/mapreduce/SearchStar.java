...
//            angelababy angelababy	55083
    ...
    public int run(String[] args) throws Exception {
        ...
        // 设置mapper信息
        job.setMapperClass(SearchStarMapper.class);
        // 设置分组partitioner信息
        job.setPartitionerClass(SearchStarPartitioner.class);
        // 设置排序combiner信息
        job.setCombinerClass(SearchStarCombiner.class);
        // 设置reduce信息
        job.setReducerClass(SearchStarReduce.class);
